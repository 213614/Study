...
<%
	...
	String domainLi = request.getParameter("domainLi").trim();
	
	email = email + domainLi;
	...
	if(cnt == 0) {
		out.println("<p>사용 가능한 이메일 주소 입니다.</p>");
%>		
...
<%
		...
		out.println("<p style='color:red; font-weight:bolder;'>이미 사용중인 이메일 주소입니다.</p>");
	}//if end
%>
	<br>
